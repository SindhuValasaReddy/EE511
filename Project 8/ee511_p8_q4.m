...
clear all;
clc;
content = fileread( 'uscap_xy.txt' ) ;  % Read file contents 
...
c = 100;
p = [4:n 1:3];                          % Initial path p
len = 0;                                % Initial length of p
for a1 = 1:n-1
...
pathHistory = zeros(num_iter,n);       % Save the paths and lengths
